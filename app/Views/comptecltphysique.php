...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
      <a class="nav-link" href="#">Compte Client Moral </a>
      </li>
    </ul>
  </div>
</nav>
   <div class="container mt-5">
      <form action="<?php echo base_url('Clientmoral/store'); ?>" method="POST">
         ...
         <div class="form-group">
            <label for="formGroupExampleInput"> Numero de Compte </label>
         ...
         <div class="form-group">
            <label for="formGroupExampleInput"> Solde Initial </label>
            <input type="text" name="adresse" class="form-control" id="formGroupExampleInput">
         </div>
         <div class="form-group">
            <label for="formGroupExampleInput"> Frais </label>
            <input type="text" name="telephone" class="form-control" id="formGroupExampleInput" require>
         </div>
         <div class="form-group">
            <label for="formGroupExampleInput"> Date Ouverture </label>
            <input type="date" name="email" class="form-control" id="formGroupExampleInput">
         </div>
