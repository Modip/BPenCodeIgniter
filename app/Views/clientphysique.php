...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
      <a class="nav-link" href="#">Ajout Client Physique </a>
      </li>
    </ul>
  </div>
</nav>
   <div class="container mt-5">
      <form action="<?php echo base_url('Clientphysique/store'); ?>" method="POST">
         ...
         <div class="form-group">
            ...
            <input type="text" name="prenom" class="form-control" id="formGroupExampleInput">
         </div>
         <div class="form-group">
            <label for="formGroupExampleInput"> Numero Identification </label>
            <input type="text" name="cni" class="form-control" id="formGroupExampleInput">
         </div>
         <div class="form-group">
